          ...
          <div class="card-deck">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">This was an internship project at Praqma. A web application that displays forms written in Yaml files in
                  a matrix.</p>
            ...
            <div class="card">
              <img class="card-img-top" src="/static/sc-admin-light.png" alt="Card image cap">
              <div class="card-body">
